...
INSERT INTO "microblog_web_profile" ("description", "displayName", "user_id", "id", "coverImage", "profileImage") SELECT "description", "displayName", "user_id", "id", "coverImage", "profileImage" FROM "microblog_web_profile__old";
