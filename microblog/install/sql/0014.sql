...
INSERT INTO "microblog_web_profile" ("description", "displayName", "profileImage", "user_id", "coverImage", "id") SELECT "description", "displayName", "profileImage", "user_id", "coverImage", "id" FROM "microblog_web_profile__old";
