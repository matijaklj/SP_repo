...
INSERT INTO "microblog_web_profile" ("user_id", "profileImage", "coverImage", "id", "displayName", "description") SELECT "user_id", "profileImage", "coverImage", "id", "displayName", "description" FROM "microblog_web_profile__old";
