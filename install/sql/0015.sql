...
INSERT INTO "microblog_web_profile" ("user_id", "profileImage", "description", "displayName", "id", "coverImage") SELECT "user_id", "profileImage", "description", "displayName", "id", "coverImage" FROM "microblog_web_profile__old";
